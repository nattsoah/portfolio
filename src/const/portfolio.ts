export const HERO_DATA = {
  ...
  title: 'Natthariga',
  subtitle: "I'm a passionate software developer specializing in building exceptional digital experiences. Currently, I'm focused on crafting responsive, accessible, and user-centered web applications.",
...
export const ABOUT_DATA = {
  title: 'About Me',
  description: [
    "Hello, I'm Natthariga Somit (Noey), a Software developer and a recent Information Technology graduate from Khon Kaen University.",
